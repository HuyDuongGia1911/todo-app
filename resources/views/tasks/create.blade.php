...
<form method="POST" action="/tasks">
    ...
    <div class="mb-3">
        <label>Ngày:</label>
        <input type="text" name="task_date" class="form-control" value="{{ now()->toDateString() }}" readonly>
    </div>
...
// Mở modal và load danh sách quản lý
...
async function deleteItem(apiUrl, id) {
    ...
    alert('Đã xoá!');
    document.querySelector('.modal.show')?.querySelector('.btn-close')?.click(); // đóng modal tạm thời
}
